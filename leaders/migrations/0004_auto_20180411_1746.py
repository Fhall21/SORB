# Generated by Django 2.0 on 2018-04-11 07:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('leaders', '0003_auto_20180411_1742'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('', 'None'), ('Campcraft', 'Campcraft'), ('Citizenship', 'Citizenship'), ('Air Activities', 'Air Activities'), ('Construction', 'Construction'), ('Environment', 'Environment'), ('Water Activities', 'Water Activities'), ('Water Safety', 'Water Safety'), ('Target Badge', 'Target Badge'), ('Chord', 'Chord')], default='None', max_length=2),
        ),
        migrations.AlterField(
            model_name='scoutdata',
            name='Explorer_Badge',
